...
void IRAM_ATTR list_init(struct list *list, int first_index) {
    // Create the mutex
...
int IRAM_ATTR list_add(struct list *list, void *item, int *item_index) {
...
int IRAM_ATTR list_remove(struct list *list, int index, int destroy) {
    struct list_index *cindex = NULL;
    int iindex;
...
void IRAM_ATTR list_destroy(struct list *list, int items) {
    int index;
